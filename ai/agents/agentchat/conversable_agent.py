...
class ConversableAgent(Agent):
    ...
    async def _print_received_message(self, message: Union[Dict, str], sender: Agent):
        ...
        log_str = str(sender.name) + "(to " + str(self.name) + "): \n"
    ...
    async def generate_oai_reply(
        ...
        print('run functon generate_oai_reply :', self.user_name)
    ...
    async def generate_reply(
        ...
        ---------------------------------------------------------------
        """
        print(' run function generate_reply: ', self.user_name)
