...
class AnalysisStarrocks(Analysis):
    ...
    async def task_base(self, qustion_message):
        ...
        try:
            ...
            for i in range(max_retry_times):
                try:
                    base_mysql_assistant = self.get_agent_base_starrocks_assistant()
    ...
    def get_agent_base_starrocks_assistant(self):
